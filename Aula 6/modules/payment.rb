module Payment 
    def pay(params = {})
      ...
      options = params[:options] || {}  # Inicializa options como um Hash vazio caso seja nulo
  
      return puts 'O valor a ser cobrado não foi enviado' unless amount
      return puts 'Quantidade mínima não alcançada.' if amount < 1
    ...
    def credit_card(options = {})
      ...
      if card_number && card_cvv && card_holder && card_expiry
        puts "Pago com sucesso com o cartão de #{card_holder} a quantia de #{amount}"
      else
